...
function regionIDDeComuna (comunaID) {
	// console.log('regionIDDeComuna', comunaID)
	// console.log('regionIDDeComuna comunasYSusRegiones', comunasYSusRegiones)
	const comuna = comunasYSusRegiones[comunaID]
	// console.log('regionIDDeComuna comuna', comuna)
