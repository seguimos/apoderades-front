...
.root(v-if="formulario")
	...
	a-form-model.enviarFormulario( ref="formulario", :model="formulario", :rules="rules" )
	...
	a-modal.modal( v-model="visible", title="Muchas gracias !!", centered, @ok="handleOk", :footer="null" )
